...
describe(
  "Liquidity Stress Pipeline — Orchestrator Integration",
  () => {
    test(
      "allows an upstream-approved position through liquidity stress",
      async () => {
        const result =
          await run();
    ...
    test(
      "passes Drawdown Recovery's reduced shares into Liquidity Stress",
      async () => {
        mocks.drawdown
          .mockReturnValue({
            approved:
    ...
    test(
      "allows Liquidity Stress to reduce the final position",
      async () => {
        mocks.liquidityStress
          .mockReturnValue({
            approved:
            ...
            reasons: [
              "Execution stress requires lower size.",
            ],
    ...
    test(
      "blocks paper execution when Liquidity Stress blocks",
      async () => {
        mocks.liquidityStress
          .mockReturnValue({
            approved:
    ...
    test(
      "never calls Liquidity Stress when Drawdown Recovery blocks",
      async () => {
        mocks.drawdown
          .mockReturnValue({
            approved:
    ...
    test(
      "orchestrator blocks a Liquidity Stress result that tries to increase shares",
      async () => {
        mocks.liquidityStress
          .mockReturnValue({
            approved:
    ...
    test(
      "passes real liquidity evidence to the Liquidity Stress engine",
      async () => {
    ...
    test(
      "tracks and exposes Liquidity Stress in orchestrator state",
      async () => {
        const result =
          await run();
