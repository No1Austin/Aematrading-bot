...
function decorateComponentSchemasWithRefName(api) {
  ...
  Object.keys(api.components.schemas).forEach((schemaName) => {
    if (isPrimitive(_optionalChain([api, 'access', _4 => _4.components, 'optionalAccess', _5 => _5.schemas, 'optionalAccess', _6 => _6[schemaName]])) || Array.isArray(_optionalChain([api, 'access', _7 => _7.components, 'optionalAccess', _8 => _8.schemas, 'optionalAccess', _9 => _9[schemaName]])) || _optionalChain([api, 'access', _10 => _10.components, 'optionalAccess', _11 => _11.schemas, 'optionalAccess', _12 => _12[schemaName]]) === null) {
      return;
    }
    (_optionalChain([api, 'access', _13 => _13.components, 'optionalAccess', _14 => _14.schemas, 'optionalAccess', _15 => _15[schemaName]]))["x-readme-ref-name"] = schemaName;
  });
}
...
function findRef($ref, definition) {
  ...
  const current = _jsonpointer2.default.get(definition, currRef);
  if (current === void 0) {
    throw new Error(`Could not find a definition for ${$ref}.`);
  }
  return current;
...
function findDiscriminatorChildren(definition) {
  ...
  if (!_optionalChain([definition, 'optionalAccess', _16 => _16.components, 'optionalAccess', _17 => _17.schemas]) || typeof definition.components.schemas !== "object") {
  ...
  for (const key of Object.keys(out.properties)) {
    ...
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, val)) {
      ...
      if (resolved !== void 0 && !isPendingSchema(resolved)) {
        const isConflictPath = _nullishCoalesce(_optionalChain([conflictPaths, 'optionalAccess', _18 => _18.has, 'call', _19 => _19(path)]), () => ( false));
      ...
      inlineAllOfRefsDeep(_nullishCoalesce(out.properties[key], () => ( val)), usedSchemas);
    }
  }
  return out;
}
function collectConflictPaths(allOfBranches, usedSchemas) {
  ...
  function recordPath(path) {
    ...
    pathBranchCount.set(path, (_nullishCoalesce(pathBranchCount.get(path), () => ( 0))) + 1);
  }
...
function resolveAndCacheRefSchema({
  ...
  if (existing !== void 0 && isPendingSchema(existing)) {
    _optionalChain([refsEmittedAsStub, 'optionalAccess', _22 => _22.add, 'call', _23 => _23(ref)]);
    return { $ref: ref };
  }
    ...
    try {
      ...
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, dereferenced)) {
        ...
        try {
          ...
          const rawSchema = _jsonpointer2.default.get(definition, pointer);
        ...
        refLogger(ref, "ref");
        _optionalChain([refsEmittedAsStub, 'optionalAccess', _24 => _24.add, 'call', _25 => _25(ref)]);
        return { $ref: ref };
      }
      ...
      _optionalChain([refsEmittedAsStub, 'optionalAccess', _26 => _26.add, 'call', _27 => _27(ref)]);
      return { $ref: ref };
    }
    const converted = toJSONSchema(structuredClone(resolved), { ...conversionOptions, seenRefs });
    usedSchemas.set(ref, converted);
    refLogger(ref, "ref");
    _optionalChain([refsEmittedAsStub, 'optionalAccess', _28 => _28.add, 'call', _29 => _29(ref)]);
    return { $ref: ref };
  }
  try {
    const dereferenced = dereferenceRef(schema, definition, seenRefs);
...
function toJSONSchema(data, opts) {
  ...
  if (_chunk7PWF3F2Wcjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild)) {
    if ("allOf" in schema && Array.isArray(schema.allOf)) {
      const siblingDescription = typeof schema.description === "string" && schema.description.length > 0 ? schema.description : void 0;
      ...
      try {
        ...
        if (siblingDescription !== void 0 && isObject(schema) && !_chunk7PWF3F2Wcjs.isRef.call(void 0, schema)) {
          schema.description = siblingDescription;
        }
      } catch (e9) {
        const branches = _nullishCoalesce(schema.allOf, () => ( []));
    ...
    ["anyOf", "oneOf"].forEach((polyType) => {
      if (polyType in schema && Array.isArray(schema[polyType])) {
        ...
        schema[polyType].forEach((item, idx) => {
          if (!_optionalChain([schema, 'access', _30 => _30[polyType], 'optionalAccess', _31 => _31[idx]])) {
            return;
          }
          const itemOptions = {
            ...polyOptions,
    ...
    if (_optionalChain([schema, 'optionalAccess', _32 => _32.discriminator, 'optionalAccess', _33 => _33.mapping]) && typeof schema.discriminator.mapping === "object") {
      ...
      if (schema.type.length === 1) {
        ...
        if (schema.type.length === 2 && isNullable) {
          ...
          Object.entries({
            ...
            if (!_optionalChain([schema, 'access', _34 => _34.type, 'optionalAccess', _35 => _35.includes, 'call', _36 => _36(typeKey)])) {
              return;
            }
    ...
    if (hasSchemaType(schema, "array")) {
      ...
      if ("properties" in schema && schema.properties !== void 0) {
        Object.keys(schema.properties).forEach((prop) => {
          if (Array.isArray(_optionalChain([schema, 'access', _37 => _37.properties, 'optionalAccess', _38 => _38[prop]])) || typeof _optionalChain([schema, 'access', _39 => _39.properties, 'optionalAccess', _40 => _40[prop]]) === "object" && _optionalChain([schema, 'access', _41 => _41.properties, 'optionalAccess', _42 => _42[prop]]) !== null) {
...
function getParametersAsJSONSchema(operation, api, opts) {
  ...
  const baseSchemaOptions = {
    definition: api,
    globalDefaults: _optionalChain([opts, 'optionalAccess', _43 => _43.globalDefaults]),
    hideReadOnlyProperties: _optionalChain([opts, 'optionalAccess', _44 => _44.hideReadOnlyProperties]),
    hideWriteOnlyProperties: _optionalChain([opts, 'optionalAccess', _45 => _45.hideWriteOnlyProperties]),
    seenRefs
  };
  function transformRequestBody() {
    const requestBody = operation.getRequestBody(_optionalChain([opts, 'optionalAccess', _46 => _46.contentType]));
  ...
  function transformParameters() {
    ...
    if (!_optionalChain([opts, 'optionalAccess', _47 => _47.mergeIntoBodyAndMetadata])) {
      return transformed;
  ...
  const typeKeys = _chunk6HXOZ5GYcjs.getExtension.call(void 0, _chunk6HXOZ5GYcjs.PARAMETER_ORDERING, api, operation).map((k) => k.toLowerCase());
...
exports.isObject = isObject; exports.isPrimitive = isPrimitive; exports.toPointer = toPointer; exports.decorateComponentSchemasWithRefName = decorateComponentSchemasWithRefName; exports.encodePointer = encodePointer; exports.decodePointer = decodePointer; exports.dereferenceRef = dereferenceRef; exports.dereferenceRefDeep = dereferenceRefDeep; exports.collectRefsInSchema = collectRefsInSchema; exports.filterRequiredRefsToReferenced = filterRequiredRefsToReferenced; exports.mergeReferencedSchemasIntoRoot = mergeReferencedSchemasIntoRoot; exports.matches_mimetype_default = matches_mimetype_default; exports.getParameterContentType = getParameterContentType; exports.cloneObject = cloneObject; exports.applyDiscriminatorOneOfToUsedSchemas = applyDiscriminatorOneOfToUsedSchemas; exports.getSchemaVersionString = getSchemaVersionString; exports.toJSONSchema = toJSONSchema; exports.types = types; exports.getParametersAsJSONSchema = getParametersAsJSONSchema; exports.supportedMethods = supportedMethods; exports.SERVER_VARIABLE_REGEX = SERVER_VARIABLE_REGEX;
//# sourceMappingURL=chunk-7WBPPWYI.cjs.map