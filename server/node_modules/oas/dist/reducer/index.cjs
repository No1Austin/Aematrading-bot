  ...
  parsePathRef($ref) {
    ...
    if (match) {
      ...
      if (pathSegment && method) {
        return { path: _chunk7WBPPWYIcjs.decodePointer.call(void 0, pathSegment), method };
      }
    }
    return null;
  }
  ...
  parseWebhookRef($ref) {
    ...
    if (match) {
      ...
      if (webhookName && method) {
        return { name: _chunk7WBPPWYIcjs.decodePointer.call(void 0, webhookName), method };
      }
    }
    return null;
  }
  ...
  walkPaths() {
    ...
    Object.keys(this.definition.paths).forEach((path) => {
      ...
      Object.keys(_optionalChain([this, 'access', _23 => _23.definition, 'access', _24 => _24.paths, 'optionalAccess', _25 => _25[path]]) || {}).forEach((method) => {
        if (method === "parameters" || !_chunk7WBPPWYIcjs.supportedMethods.includes(method.toLowerCase())) {
          return;
        }
        if (this.hasPathsToReduceBy) {
  ...
  reducePaths() {
    ...
    Object.keys(this.definition.paths).forEach((path) => {
      ...
      Object.keys(_optionalChain([this, 'access', _39 => _39.definition, 'access', _40 => _40.paths, 'optionalAccess', _41 => _41[path]]) || {}).forEach((method) => {
        const methodLC = method.toLowerCase();
        if (method === "parameters" || !_chunk7WBPPWYIcjs.supportedMethods.includes(methodLC)) {
          return;
        }
