...
var _chunk3ZXZMZXTcjs = require('./chunk-3ZXZMZXT.cjs');
...
function getAuth(api, user, selectedApp) {
  return Object.keys(_optionalChain([api, 'optionalAccess', _3 => _3.components, 'optionalAccess', _4 => _4.securitySchemes]) || {}).map((scheme) => {
    const securityScheme = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, _optionalChain([api, 'access', _5 => _5.components, 'optionalAccess', _6 => _6.securitySchemes, 'optionalAccess', _7 => _7[scheme]]), api);
...
var Oas = class _Oas {
  ...
  url(selected = 0, variables) {
    const url = _optionalChain([this, 'access', _8 => _8.api, 'access', _9 => _9.servers, 'optionalAccess', _10 => _10[selected], 'optionalAccess', _11 => _11.url]);
    const resolvedUrl = url ? this.replaceUrl(url, variables || this.defaultVariables(selected)) : void 0;
    return _chunk3ZXZMZXTcjs.normalizeURL.call(void 0, resolvedUrl).trim();
  }
  variables(selected = 0) {
    return _chunk3ZXZMZXTcjs.variablesFromServers.call(void 0, this.api.servers, selected);
  }
  defaultVariables(selected = 0) {
    return _chunk3ZXZMZXTcjs.defaultVariablesFromServers.call(void 0, this.api.servers, selected, this.user);
  }
  splitUrl(selected = 0) {
    return _chunk3ZXZMZXTcjs.splitUrlFromServers.call(void 0, this.api.servers, selected);
  }
  /**
  ...
  splitVariables(baseUrl) {
    const matchedServer = (this.api.servers || []).map((server, i) => {
      const rgx = _chunk3ZXZMZXTcjs.transformURLIntoRegex.call(void 0, server.url);
      const found = new RegExp(rgx).exec(baseUrl);
      if (!found) {
        return false;
      }
      const variables = {};
      Array.from(server.url.matchAll(_chunk7WBPPWYIcjs.SERVER_VARIABLE_REGEX)).forEach((variable, y) => {
  ...
  replaceUrl(url, variables = {}) {
    return _chunk3ZXZMZXTcjs.stripTrailingSlash.call(void 0, 
      url.replace(_chunk7WBPPWYIcjs.SERVER_VARIABLE_REGEX, (original, key) => {
        if (key in variables) {
        ...
        const userVariable = _chunk3ZXZMZXTcjs.getUserVariable.call(void 0, this.user, key);
        if (userVariable) {
  ...
  operation(path, method, opts = {}) {
    ...
    if (opts.isWebhook) {
      if (_chunk7PWF3F2Wcjs.isOpenAPI31.call(void 0, this.api)) {
        const webhookPath = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, _optionalChain([this, 'access', _12 => _12.api, 'optionalAccess', _13 => _13.webhooks, 'optionalAccess', _14 => _14[path]]), this.api);
        if (webhookPath && !_chunk7PWF3F2Wcjs.isRef.call(void 0, webhookPath)) {
          if (_optionalChain([webhookPath, 'optionalAccess', _15 => _15[method]])) {
            operation = webhookPath[method];
            return new (0, _chunk3ZXZMZXTcjs.Webhook)(this, path, method, operation);
          }
        }
      }
    }
    if (_optionalChain([this, 'optionalAccess', _16 => _16.api, 'optionalAccess', _17 => _17.paths, 'optionalAccess', _18 => _18[path]])) {
      const pathItem = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, this.api.paths[path], this.api);
      if (_optionalChain([pathItem, 'optionalAccess', _19 => _19[method]])) {
        operation = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, pathItem[method], this.api);
      }
    }
    return new (0, _chunk3ZXZMZXTcjs.Operation)(this, path, method, operation);
  }
   ...
   */
  findRootServerOperationMatches(url) {
    ...
    const substituted = matchedServer ? this.splitURLOnSubstitutedServer(url, matchedServer) : void 0;
    let target = _optionalChain([substituted, 'optionalAccess', _20 => _20.pathName]) ? substituted : void 0;
    if (!target) {
    ...
    if (!target || !paths) return void 0;
    const annotatedPaths = _chunk3ZXZMZXTcjs.generatePathMatches.call(void 0, paths, target.pathName || "/", target.origin);
    if (!annotatedPaths.length) return void 0;
    return annotatedPaths;
  }
  /**
   ...
   */
  findOverriddenServerOperationMatches(url) {
    ...
    Object.keys(paths).forEach((path) => {
      ...
      let mayHaveOverrides = _chunk7PWF3F2Wcjs.isRef.call(void 0, rawPathItem) || !!_optionalChain([rawPathItem, 'access', _21 => _21.servers, 'optionalAccess', _22 => _22.length]);
      if (!mayHaveOverrides) {
        for (const method of _chunk7WBPPWYIcjs.supportedMethods) {
          const rawOperation = rawPathItem[method];
          if (rawOperation && (_chunk7PWF3F2Wcjs.isRef.call(void 0, rawOperation) || _optionalChain([rawOperation, 'access', _23 => _23.servers, 'optionalAccess', _24 => _24.length]))) {
      ...
      const pathItem = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, rawPathItem, this.api);
      if (!pathItem || _chunk7PWF3F2Wcjs.isRef.call(void 0, pathItem)) return;
      const groups = /* @__PURE__ */ new Map();
      _chunk7WBPPWYIcjs.supportedMethods.forEach((method) => {
        const operation = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, pathItem[method], this.api);
        if (!operation || _chunk7PWF3F2Wcjs.isRef.call(void 0, operation)) return;
        const servers = _optionalChain([operation, 'access', _25 => _25.servers, 'optionalAccess', _26 => _26.length]) ? operation.servers : _optionalChain([pathItem, 'access', _27 => _27.servers, 'optionalAccess', _28 => _28.length]) ? pathItem.servers : void 0;
        if (!servers) return;
      ...
      groups.forEach(({ operations, servers }) => {
        for (const server of servers) {
          ...
          if (!target) continue;
          const annotatedPaths = _chunk3ZXZMZXTcjs.generatePathMatches.call(void 0, 
            { [path]: operations },
            target.pathName || "/",
            target.origin
          );
   ...
   */
  splitURLIntoOriginAndPathName(url, server) {
   ...
   */
  splitURLOnSubstitutedServer(url, server) {
    try {
   ...
   */
  splitURLOnServerRegex(url, server) {
    try {
      const regex = _chunk3ZXZMZXTcjs.transformURLIntoRegex.call(void 0, server.url);
  ...
  findOperation(url, method) {
    ...
    const matches = _chunk3ZXZMZXTcjs.filterPathMethods.call(void 0, annotatedPaths, method);
    if (!matches.length) return void 0;
    return _chunk3ZXZMZXTcjs.findTargetPath.call(void 0, matches);
  }
  /**
  ...
  findOperationWithoutMethod(url) {
    ...
    return _chunk3ZXZMZXTcjs.findTargetPath.call(void 0, annotatedPaths);
  }
  /**
  ...
  getAuth(user, selectedApp) {
    if (!_optionalChain([this, 'access', _29 => _29.api, 'optionalAccess', _30 => _30.components, 'optionalAccess', _31 => _31.securitySchemes])) {
      return {};
    }
  ...
  hasSecurityScheme(name) {
    return Boolean(_optionalChain([this, 'access', _32 => _32.api, 'optionalAccess', _33 => _33.components, 'optionalAccess', _34 => _34.securitySchemes, 'optionalAccess', _35 => _35[name]]));
  }
  /**
  ...
  getSecurityScheme(name) {
    ...
    let scheme = _optionalChain([this, 'access', _36 => _36.api, 'optionalAccess', _37 => _37.components, 'optionalAccess', _38 => _38.securitySchemes, 'optionalAccess', _39 => _39[name]]);
    if (!scheme) return void 0;
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, scheme)) {
      scheme = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, scheme, this.api);
  ...
  getPaths() {
    ...
    Object.keys(this.api.paths).forEach((path) => {
      ...
      if (!pathItem) {
        ...
        this.api.paths[path] = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, pathItem, this.api);
      ...
      Object.keys(pathItem).forEach((method) => {
        if (!_chunk7WBPPWYIcjs.supportedMethods.includes(method)) {
          return;
        }
  ...
  getWebhooks() {
    ...
    Object.keys(this.api.webhooks).forEach((id) => {
      webhooks[id] = {};
      const webhookPath = _chunk7WBPPWYIcjs.dereferenceRef.call(void 0, _optionalChain([this, 'access', _40 => _40.api, 'access', _41 => _41.webhooks, 'optionalAccess', _42 => _42[id]]), this.api);
      if (webhookPath) {
  ...
  getTags(setIfMissing = false) {
    ...
    const oasTags = _optionalChain([this, 'access', _43 => _43.api, 'access', _44 => _44.tags, 'optionalAccess', _45 => _45.map, 'call', _46 => _46((tag) => tag.name)]) || [];
    const disableTagSorting = _chunk6HXOZ5GYcjs.getExtension.call(void 0, "disable-tag-sorting", this.api);
  ...
  hasExtension(extension) {
    return _chunk6HXOZ5GYcjs.hasRootExtension.call(void 0, extension, this.api);
  }
  /**
  ...
  getExtension(extension, operation) {
    return _chunk6HXOZ5GYcjs.getExtension.call(void 0, extension, this.api, operation);
  }
  /**
  ...
  validateExtension(extension) {
    if (this.hasExtension("x-readme")) {
      ...
      if (extension in data) {
        if ([_chunk6HXOZ5GYcjs.CODE_SAMPLES, _chunk6HXOZ5GYcjs.HEADERS, _chunk6HXOZ5GYcjs.PARAMETER_ORDERING, _chunk6HXOZ5GYcjs.SAMPLES_LANGUAGES].includes(extension)) {
          if (data[extension] !== void 0) {
            if (!Array.isArray(data[extension])) {
              throw new TypeError(`"x-readme.${extension}" must be of type "Array"`);
            }
            if (extension === _chunk6HXOZ5GYcjs.PARAMETER_ORDERING) {
              _chunk6HXOZ5GYcjs.validateParameterOrdering.call(void 0, data[extension], `x-readme.${extension}`);
            }
          }
        } else if (extension === _chunk6HXOZ5GYcjs.OAUTH_OPTIONS) {
          if (typeof data[extension] !== "object") {
            throw new TypeError(`"x-readme.${extension}" must be of type "Object"`);
          }
        } else if (extension === _chunk6HXOZ5GYcjs.STATUS_URL) {
    ...
    if (this.hasExtension(`x-${extension}`)) {
      ...
      if ([_chunk6HXOZ5GYcjs.CODE_SAMPLES, _chunk6HXOZ5GYcjs.HEADERS, _chunk6HXOZ5GYcjs.PARAMETER_ORDERING, _chunk6HXOZ5GYcjs.SAMPLES_LANGUAGES].includes(extension)) {
        ...
        if (extension === _chunk6HXOZ5GYcjs.PARAMETER_ORDERING) {
          _chunk6HXOZ5GYcjs.validateParameterOrdering.call(void 0, data, `x-${extension}`);
        }
      } else if (extension === _chunk6HXOZ5GYcjs.OAUTH_OPTIONS) {
        if (typeof data !== "object") {
   ...
   */
  validateExtensions() {
    Object.keys(_chunk6HXOZ5GYcjs.extensionDefaults).forEach((extension) => {
